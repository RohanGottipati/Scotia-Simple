...
export default function MoneyMomentCard() {
  ...
  if (momentConfirmed) {
    return (
      <div className="bg-scotia-green-light rounded-2xl p-4 border border-scotia-green/20">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            <p className="text-[14px] font-semibold text-scotia-grey-900">$25 invested in your TFSA</p>
            <p className="text-[12px] text-scotia-grey-500 mt-0.5">Done! More moments in history.</p>
          </div>
          <ChevronRight size={16} className="text-scotia-grey-300 flex-shrink-0" />
        </div>
      </div>
    );
  }
    ...
    >
      ...
      <div className="flex items-center justify-between mt-3 pt-3 border-t border-scotia-grey-100">
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-[18px] font-bold text-scotia-red">${ACTIVE_MOMENT.suggestedAmount}</span>
